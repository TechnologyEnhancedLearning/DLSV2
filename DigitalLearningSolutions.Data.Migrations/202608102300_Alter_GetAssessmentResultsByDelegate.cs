namespace DigitalLearningSolutions.Data.Migrations
{
    ...
    public class Alter_GetAssessmentResultByDelegate : Migration
    {
        public override void Up()
        {
            ...
            Execute.Sql(@"CREATE NONCLUSTERED INDEX IX_CandidateAssessments_Active_Assessment_Delegate ON dbo.CandidateAssessments (SelfAssessmentID, DelegateUserID) INCLUDE (ID) WHERE RemovedDate IS NULL;");
            ...
            Execute.Sql(Properties.Resources.TD_7273_Alter_GetAssessmentResultsByDelegate_Up);
        }
        public override void Down()
        {
            ...
            Execute.Sql(Properties.Resources.TD_7273_Alter_GetAssessmentResultsByDelegate_Down);
        }
    }
}
