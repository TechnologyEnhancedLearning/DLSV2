...
{
    [Migration(202408221440)]
    public class UpdatePrivacyPolicyRecord : Migration
    {
        public override void Up()
        {
            var PrivacyPolicy = @"<h1 class=""policy-text-center"">PRIVACY NOTICE</h1>
                                    ...
                                    <ol class=""h4 nhsuk-body-m nhsuk-u-padding-top-1 nhsuk-u-padding-left-0"">
                                           We will keep personal data for no longer than necessary to fulfil the purposes we collected it for, in accordance with our records management policy and the NHS records retention schedule within the NHS Records Management Code of Practice at: <a class=""policy-word-break"" href=""https://www.england.nhs.uk/contact-us/privacy-notice/nhs-england-as-a-data-controller"">https://www.england.nhs.uk/contact-us/privacy-notice/nhs-england-as-a-data-controller</a> (as may be amended from time to time).
                                            </ol>
                                    <ol class=""h4 nhsuk-body-m nhsuk-u-padding-top-1 nhsuk-u-padding-left-0"">
                                   ...
                                   ";
            Execute.Sql(
                @"Update Config SET ConfigText =N'" + PrivacyPolicy + "' " +
                         "WHERE ConfigName = 'PrivacyPolicy';"
           );
        }
