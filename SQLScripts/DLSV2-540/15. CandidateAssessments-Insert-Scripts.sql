BEGIN TRANSACTION
	...
	BEGIN TRY
			...
			INSERT [dbo].[CandidateAssessments] ([CandidateID], [SelfAssessmentID], [StartedDate], [LastAccessed], [CompleteByDate], [UserBookmark], [UnprocessedUpdates], [LaunchCount], [CompletedDate], [RemovedDate], [RemovalMethodID], [EnrolmentMethodId], [EnrolledByAdminId], [ID], [SubmittedDate]) VALUES (11, 5, CAST(N'2020-09-09T09:28:54.557' AS DateTime), CAST(N'2021-12-15T10:38:48.017' AS DateTime), NULL, NULL, 0, 11, NULL, CAST(N'2021-07-22T14:00:24.507' AS DateTime), 2, 1, NULL, 5, NULL)
