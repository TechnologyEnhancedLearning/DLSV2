namespace DigitalLearningSolutions.Web.Tests.Controllers.TrackingSystem.Delegates
{
    ...
    internal class ViewDelegateControllerTests
    {
        ...
        [Test]
        public void Removal_confirmation_page_for_nonexistent_delegate_returns_not_found_result()
        {
            // given
            A.CallTo(() => courseDataService.GetCourseNameAndApplication(1))
                .Returns(new CourseNameInfo());
        ...
        [Test]
        public void Removal_confirmation_page_for_nonexistent_course_returns_not_found_result()
        {
            // given
            A.CallTo(() => userDataService.GetDelegateUserCardById(1))
                .Returns(new DelegateUserCard { CentreId = 2, Id = 1 });
        ...
        [Test]
        public void Removal_confirmation_page_for_delegate_on_wrong_centre_returns_not_found_result()
        {
            // given
            A.CallTo(() => userDataService.GetDelegateUserCardById(1))
                .Returns(new DelegateUserCard { CentreId = 3, Id = 1 });
            A.CallTo(() => courseDataService.GetCourseNameAndApplication(1))
                .Returns(new CourseNameInfo());
        ...
        [Test]
        public void Delegate_removal_for_nonexistent_delegate_returns_not_found_result()
        {
            // given
            A.CallTo(() => userDataService.GetDelegateUserCardById(-1))
                .Returns(null);
        ...
        [Test]
        public void Delegate_removal_for_delegate_on_wrong_centre_returns_not_found_result()
        {
            // given
            A.CallTo(() => userDataService.GetDelegateUserCardById(1))
                .Returns(new DelegateUserCard { CentreId = 3, Id = 1 });
