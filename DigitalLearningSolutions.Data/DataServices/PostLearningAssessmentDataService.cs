namespace DigitalLearningSolutions.Data.DataServices
{
    ...
    public class PostLearningAssessmentDataService : IPostLearningAssessmentDataService
    {
        private readonly IDbConnection connection;
        private readonly ILogger<PostLearningAssessmentDataService> logger;

        public PostLearningAssessmentDataService(IDbConnection connection, ILogger<PostLearningAssessmentDataService> logger)
        {
