namespace DigitalLearningSolutions.Data.DataServices
{
    ...
    public interface ICourseCompletionDataService
    {
        CourseCompletion? GetCourseCompletion(int candidateId, int customisationId);
    }

    public class CourseCompletionDataService : ICourseCompletionDataService
    {
        private readonly IDbConnection connection;

        public CourseCompletionDataService(IDbConnection connection)
        {
