namespace DigitalLearningSolutions.Data.DataServices
{
    ...
    public interface ICourseContentDataService
    {
    ...
    public class CourseContentDataService : ICourseContentDataService
    {
        private readonly IDbConnection connection;
        private readonly ILogger<CourseContentDataService> logger;

        public CourseContentDataService(IDbConnection connection, ILogger<CourseContentDataService> logger)
        {
