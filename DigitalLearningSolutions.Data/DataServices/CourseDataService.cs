    ...
    public class CourseDataService : ICourseDataService
    {
        ...
        private const string SelectDelegateCourseInfoQuery =
            @"SELECT
                ...
                CASE WHEN auSupervisor.Active = 1 THEN auSupervisor.AdminID ELSE NULL END AS SupervisorAdminId,
                CASE WHEN auSupervisor.Active = 1 THEN auSupervisor.Forename ELSE NULL END AS SupervisorForename,
                CASE WHEN auSupervisor.Active = 1 THEN auSupervisor.Surname ELSE NULL END AS SupervisorSurname,
                ...
                CASE WHEN auEnrolledBy.Active = 1 THEN auEnrolledBy.AdminID ELSE NULL END AS EnrolledByAdminId,
                CASE WHEN auEnrolledBy.Active = 1 THEN auEnrolledBy.Forename ELSE NULL END AS EnrolledByForename,
                CASE WHEN auEnrolledBy.Active = 1 THEN auEnrolledBy.Surname ELSE NULL END AS EnrolledBySurname,
