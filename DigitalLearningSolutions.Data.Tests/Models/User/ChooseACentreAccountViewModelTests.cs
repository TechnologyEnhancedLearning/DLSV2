namespace DigitalLearningSolutions.Data.Tests.Models.User
{
    ...
    public class ChooseACentreAccountViewModelTests
    {
        ...
        [TestCase(true, true, true, true, true, false, "Active", "green", "Choose")]
        [TestCase(true, false, true, true, true, false, "Active", "green", "Choose")]
        // [TestCase(true, true, false, true, true)] - !isDelegate && isDelegateApproved
        [TestCase(true, true, true, false, true, false, "Delegate unapproved", "grey", "Choose")]
        [TestCase(true, true, true, true, false, false, "Delegate inactive", "red", "Choose")]
        // [TestCase(true, false, false, true, true)]- !isAdmin && !isDelegate && isDelegateApproved && isDelegateActive
        [TestCase(true, false, true, false, true, false, "Unapproved", "grey")]
        [TestCase(true, false, true, true, false, false, "Inactive", "red", "Reactivate")]
        ...
        [TestCase(true, true, true, false, false, false, "Delegate inactive", "red", "Choose")]
        [TestCase(true, true, false, false, false, false, "Active", "green", "Choose")]
        [TestCase(true, false, true, false, false, false, "Inactive", "red", "Reactivate")]
        ...
        [TestCase(true, true, true, true, true, true, "Email unverified", "red")]
        [TestCase(true, true, true, true, false, true, "Email unverified", "red")]
        [TestCase(true, true, true, false, true, true, "Email unverified", "red")]
        [TestCase(true, true, false, true, true, true, "Email unverified", "red")]
        [TestCase(true, false, true, true, true, true, "Email unverified", "red")]

        // Inactive centre test cases
        [TestCase(false, true, true, true, true, false, "Centre inactive", "grey")]
        [TestCase(false, false, true, true, true, false, "Centre inactive", "grey")]
        // [TestCase(false, true, false, true, true)] - !isDelegate && isDelegateApproved
        [TestCase(false, true, true, false, true, false, "Centre inactive", "grey")]
        [TestCase(false, true, true, true, false, false, "Centre inactive", "grey")]
        // [TestCase(false, false, false, true, true)]- !isAdmin && !isDelegate && isDelegateApproved && isDelegateActive
        [TestCase(false, false, true, false, true, false, "Centre inactive", "grey")]
        [TestCase(false, false, true, true, false, false, "Centre inactive", "grey")]
        ...
        [TestCase(false, true, true, false, false, false, "Centre inactive", "grey")]
        [TestCase(false, true, false, false, false, false, "Centre inactive", "grey")]
        [TestCase(false, false, true, false, false, false, "Centre inactive", "grey")]
        ...
        [TestCase(false, true, false, true, true, false, "Centre inactive", "grey")]
        // [TestCase(false, true, true, false, true)] - !isDelegate && isDelegateActive
        [TestCase(false, true, true, true, false, false, "Centre inactive", "grey")]
        [TestCase(false, false, false, true, true, false, "Centre inactive", "grey")]
        ...
        [TestCase(false, true, false, true, false, false, "Centre inactive", "grey")]
        [TestCase(false, true, true, false, false, false, "Centre inactive", "grey")]
        // [TestCase(false, true, false, false, false)] - !isAdmin && !isDelegate
        // [TestCase(false, false, true, false, false)] - isAdmin && !isApproved
        [TestCase(false, false, false, true, false, false, "Centre inactive", "grey")]
        // [TestCase(false, false, false, false, true)] - !isAdmin && !isDelegate && isDelegateActive
        // [TestCase(false, false, false, false, false)] - !isAdmin && !isDelegate
