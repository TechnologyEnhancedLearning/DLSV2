    ...
    public class UserServiceTests
    {
        ...
        public void TryUpdateUsers_with_null_delegate_only_updates_admin()
        {
            ...
            var accountDetailsData =
                new AccountDetailsData(adminUser.Id, null, password, firstName, lastName, email, professionalRegNumber, YesNoSelectionEnum.Yes, null);
        ...
        public void TryUpdateUsers_with_null_admin_only_updates_delegate()
        {
            ...
            var email = "test@email.com";
            var accountDetailsData =
                new AccountDetailsData(null, delegateUser.Id, password, firstName, lastName, email, null, YesNoSelectionEnum.No, null);
        ...
        public void TryUpdateUsers_with_both_admin_and_delegate_updates_both()
        {
            ...
            var professionalRegNumber = "test-1234";
            var accountDetailsData =
                new AccountDetailsData(adminUser.Id, delegateUser.Id, password, firstName, lastName, email, professionalRegNumber, YesNoSelectionEnum.Yes, null);
            var centreAnswersData = new CentreAnswersData(2, 1, null, null, null, null, null, null);
