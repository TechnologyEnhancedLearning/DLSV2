...
namespace DigitalLearningSolutions.Web.Controllers.TrackingSystem.Delegates
{
    ...
    public partial class EnrolController : Controller
    {
        ...
        {
            var sessionEnrol = multiPageFormService.GetMultiPageFormData<SessionEnrolDelegate>(
               MultiPageFormDataFeature.EnrolDelegateInActivity, TempData).GetAwaiter().GetResult();
            ...
            multiPageFormService.SetMultiPageFormData(sessionEnrol, MultiPageFormDataFeature.EnrolDelegateInActivity, TempData).GetAwaiter().GetResult();
