namespace DigitalLearningSolutions.Web.Helpers
{
    public static class CommonValidationErrorMessages
    {
        ...
        public const string DuplicateEmailError = "A user with this email address is already registered; if this is you, please log in at this centre via the My Account page";
